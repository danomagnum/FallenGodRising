...
def genzone(game):
	...
	maps.maptools.overworld_inject(game, zone, newchar='p', mask=maps.buildings.building_octagon(maptools.MAPSIZE[0], maptools.MAPSIZE[1], padding=5,outside_door=True))
