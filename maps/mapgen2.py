...
CHARACTER_TILES = {'stone': ' ', 'floor': '.', 'wall': '#'}
...
if __name__ == '__main__':
	...
	gen = Generator( width=64, height=40, max_rooms=15, min_room_xy=6, max_room_xy=10, rooms_overlap=True, random_connections=1, random_spurs=1, tiles=CHARACTER_TILES)
